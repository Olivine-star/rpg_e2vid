...
from utils.inference_utils2 import CropParameters, EventPreprocessor, IntensityRescaler, ImageFilter, ImageDisplay, ImageWriter, UnsharpMaskFilter
from utils.inference_utils2 import upsample_color_image, merge_channels_into_color_image  # for color reconstruction
...
class ImageReconstructor:
    ...
    def initialize(self, height, width, options):
        options.output_dir = r"C:\code\EventSR-Project\test-IR"
